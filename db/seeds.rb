...
bills = "bills?congress=114&fields=bill_id,official_title,popular_title,summary_short,introduced_on,last_vote_at,keywords,history.enacted&order=history.enacted&per_page=50&page="
bill_data = []
